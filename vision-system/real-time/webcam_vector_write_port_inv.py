...
def calculate_joint_angles(kpts, out_dict):
    ...
    for joint in kpts['joints']:
        ...
        qua = anglesToQuaternion(kpts[joint+'_angles'][1], kpts[joint+'_angles'][2], kpts[joint+'_angles'][0]) #tz, tx, ty
...
if __name__ == '__main__':
    ...
    # Initiates camera 
    cap = cv2.VideoCapture(0)     # modify depending your cam device
    ...
    if True:
        while True:
            ...
            if results.pose_world_landmarks:
                ...
                # TODO: Gather chunks of frame instead of frame by frame and apply median filter

                get_bone_lengths(kpts)
                get_base_skeleton(kpts)

                calculate_joint_angles(kpts, output_dict)
                ...
                # plot_img is rgb, convert to opencv's default bgr
